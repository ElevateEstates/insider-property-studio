  ...
  return (
    <section className="py-32 px-6 bg-black">
      <div className="container mx-auto max-w-4xl">
        <div className="mb-16">
          <h2 className="text-5xl md:text-6xl font-light mb-8 border-b border-white/20 pb-4">
            About
          </h2>
        </div>
        
        <div className="space-y-8 text-lg md:text-xl leading-relaxed text-white/90 font-light">
          <p>
