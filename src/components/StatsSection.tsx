...
export const StatsSection = () => {
  ...
  return (
    <section ref={combinedRef} className="py-12 md:py-16 px-4 md:px-6 relative overflow-hidden z-10">
      ...
      <div 
        className="container mx-auto max-w-6xl relative z-20 section-content py-6 md:py-8 px-4 md:px-8"
        style={{ transform: `translateY(${scrollY * 0.05}px)` }}
      >
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-light mb-6 md:mb-8 text-white leading-tight px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 px-2">
          {stats.map((stat, index) => (
            <div key={index} className="glass-card text-center rounded-2xl p-4 md:p-6 lg:p-8">
        ...
        <div className="mt-12 md:mt-20 space-y-2 text-center px-4">
