...
export const Hero = () => {
  ...
  return (
    <header ref={heroRef} className="relative min-h-screen text-white transparent-section">
      <div className="relative z-30 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 md:px-8 lg:px-16 section-content">
        <div className="max-w-7xl w-full text-center space-y-8 md:space-y-12 py-16 md:py-20 pb-24 md:pb-32">
          <div className="space-y-6 md:space-y-8 lg:space-y-12">
            {/* Main Heading */}
            <div className="space-y-4 md:space-y-6">
              <FadeInText 
                text="Your partner in" 
                className="block text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-light leading-[0.9] tracking-tight" 
                delay={0} 
              ...
              <FadeInText 
                ...
                className="block text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-light leading-[0.9] tracking-tight text-gradient-gold" 
                delay={400} 
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center pt-6 md:pt-8 px-4">
              <div className={`transition-all duration-700 ${hasAnimated('hero-cta-1') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                <Button 
                  variant="primary" 
                  size="lg"
                  className="w-full sm:w-auto text-sm sm:text-base md:text-lg px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-6 h-auto min-h-[44px] sm:min-h-[48px]"
        ...
        <div className="absolute bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          <div className="w-5 h-8 md:w-6 md:h-10 border-2 border-white/30 rounded-full flex justify-center">
            <div className="w-1 h-2 md:h-3 bg-white/50 rounded-full mt-1.5 md:mt-2 animate-pulse"></div>
          </div>
        </div>
      </div>
    </header>
